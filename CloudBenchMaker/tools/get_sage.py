...
Download random images from Sage Continuum sensor network for the CloudBench benchmark.
...
# Image task types to query, top camera usually shows the sky
IMAGE_TASKS = "imagesampler-top"

# Sample size
SAMPLE_SIZE = 2543  # Total number of images to sample

# Output configuration
OUTPUT_DIR = "/tmp/CloudBench/images/sage"
RANDOM_SEED = 14
